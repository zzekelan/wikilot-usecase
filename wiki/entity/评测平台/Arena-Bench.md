...
Arena Bench 是 ICML 2024 [[wiki/source/模型评测/chatbot-arena|Arena 论文]]中从众包提示筛出的 **350 个固定问题**组成的派生基准。[[wiki/entity/评测平台/Chatbot-Arena|Chatbot Arena]]实时收集真人票；Arena Bench 使用 GPT-4-Turbo 评审，是静态问题与自动偏好评价的组合（第 6–7、26–27 页）。
...
参考答案、裁判和筛题过程共同影响分数。理解结果时，应连同[[wiki/concept/偏好与统计/LLM评审|LLM 评审协议]]一起阅读，而非把 0–10 分等同真人平台的 BT 分数。
