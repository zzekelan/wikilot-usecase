...
Chatbot Arena 是由 UC Berkeley 研究人员发起的开放大模型评测平台，自 2023 年 4 月收集匿名对战与人类偏好。用户自由提问，比较两个模型回答后投票；平台以统计方法汇总排名。研究发表于 [[wiki/source/模型评测/chatbot-arena|ICML 2024 论文]]。
...
- [[wiki/concept/偏好与统计/成对比较|匿名成对比较]]提供反馈。
- [[wiki/concept/偏好与统计/Bradley-Terry模型|BT 模型]]估计分数。
- [[wiki/concept/偏好与统计/同时统计推断|同时区间]]描述名次不确定性。
- [[wiki/synthesis/偏好与评测/主动分配评审预算与估计校正|主动采样与加权]]提高预算效率并校正模型对分配。
- [[wiki/concept/偏好与统计/主题建模|主题分析]]与[[wiki/concept/偏好与统计/异常投票检测|异常筛查]]检查数据结构和质量。
...
- [[wiki/entity/评测平台/Arena-Bench|Arena Bench]]：Arena Bench 从平台提示中筛选构建。
